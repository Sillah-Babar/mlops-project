...
def inference(file):
    ...
    WEIGHT_PATH  = os.path.join('weights','best_val_model.h5')
    #model= keras.models.load_model('best_val_model.h5',compile=False)
    ...
    PREDICT_DICTIONARY  = os.path.join(CURRENT_PATH,'urdu_sentences.txt')
    ...
    #new_result=result[0]
    new_result='میں کیسے تھے ہاں کب تین'
